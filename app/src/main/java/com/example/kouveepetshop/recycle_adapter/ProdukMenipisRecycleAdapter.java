...
public class ProdukMenipisRecycleAdapter extends RecyclerView.Adapter<ProdukMenipisRecycleAdapter.MyViewHolder> implements Filterable {

    private Context context;
    private List<ProdukModel> result;
    private List<ProdukModel> resultFull;

    public ProdukMenipisRecycleAdapter(Context context, List<ProdukModel> result) {
